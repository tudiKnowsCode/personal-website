...
function ServiceCard({ service, index }: { service: typeof services[0]; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-gradient-to-br from-[#4f8ef7]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-[20px]"
      />

      <div className="relative z-10">
        <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110 bg-[#4f8ef7]/10">
          <Icon size={22} className="text-[#4f8ef7]" strokeWidth={1.8} />
        </div>
    ...
    <section id="services" className="relative py-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16" ref={ref}>
          ...
          >
            Everything from first sketch to launch day, handled by one person who actually cares how it turns out.
          </motion.p>
        </div>
