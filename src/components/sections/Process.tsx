...
const steps = [
  {
    ...
    description: 'I start by getting to know your business, your audience, and your goals. No templates. Your strategy is built from scratch.',
  },
  {
    number: '02',
    icon: Lightbulb,
  ...
  },
  {
    ...
    icon: Rocket,
    title: 'Launch',
    description: 'Thorough QA, performance optimization, SEO setup, and a smooth launch. I handle everything so you can hit go with confidence.',
  },
  {
    number: '05',
    icon: Headphones,
    ...
    <section id="process" className="relative py-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6" ref={ref}>
        <div className="text-center mb-16">
          ...
          >
            Five steps, no surprises. You will always know exactly where your project stands.
          </motion.p>
        </div>
            ...
            {steps.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Icon */}
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 bg-[#4f8ef7]/10">
                  ...
                  <div className="hidden lg:block absolute -top-2 left-1/2 -translate-x-1/2 w-4 h-4 rounded-full border-2 border-[#07070f] shadow-lg bg-[#4f8ef7]" />
                </motion.div>
              )
            })}
          </div>
